...
const LanguageSelector = () => {
  ...
  const handleLanguageChange = (event: LanguageChangeEvent): void => {
    ...
    setCurrentLanguage(selectedLanguage); /** Update the state with the selected language */
  ...
  return (
    ...
    <div className="language-selector d-flex justify-content-end mr20 ml20">
      <select
        className="col-lg-2 form-select"
        value={currentLanguage} /** Display the current language in the dropdown */
        onChange={handleLanguageChange} /** Trigger language change on selection */
      >
