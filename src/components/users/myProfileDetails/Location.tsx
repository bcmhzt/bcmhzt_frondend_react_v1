...
if (debug === 'true') console.log('[Location.tsx] debug:', debug);
...
const Location = () => {
  ...
  return (
    <div className="profile-update location">
      <h3>
        地域<span className="require">必須</span>
      </h3>
      ...
      <select className="form-select" value={value} onChange={handleChange}>
        <option selected>地域を選択してください</option>
        ...
        <option value="その他（外国など）">その他（外国など）</option>
