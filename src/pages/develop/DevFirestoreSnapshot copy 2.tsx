...
/**
 * bcuid "ac1-69ed2669"（文字列）
 * created_at 2025年6月16日 15:05:37 UTC+9 （タイムスタンプ）
 * deleted false （ブール値）
 * nickname "モリリver2.8" （文字列）
 * image_url "https://firebasestorage.googleapis.com/v0/b/your-app-id.appspot.com/o/profiles/Ptp2VzffuSOklLbFADqeSEvgbXW2/Ptp2VzffuSOklLbFADqeSEvgbXW2.jpg?alt=media&token=your-token" （文字列）
 * profile_images "profiles/Ptp2VzffuSOklLbFADqeSEvgbXW2/Ptp2VzffuSOklLbFADqeSEvgbXW2.jpg" （文字列）
 * text "hello" （文字列）
 * uid "Ptp2VzffuSOklLbFADqeSEvgbXW2" （文字列）
 */
interface OpenTalk {
  uid: string;
  bcuid: string;
